...
static int r_mark_regions(struct SN_env * z) {
    ...
    {   int c1 = z->c; /* do, line 111 */
        {    /* gopast */ /* grouping v, line 112 */
            int ret = out_grouping_U(z, g_v, 97, 371, 1);
            if (ret < 0) goto lab0;
            z->c += ret;
        }
        {    /* gopast */ /* non v, line 112 */
            int ret = in_grouping_U(z, g_v, 97, 371, 1);
            if (ret < 0) goto lab0;
            z->c += ret;
        }
        z->I[0] = z->c; /* setmark p1, line 112 */
        {    /* gopast */ /* non v, line 113 */
            int ret = in_grouping_U(z, g_v, 97, 371, 1);
            if (ret < 0) goto lab0;
            z->c += ret;
        }
        z->I[1] = z->c; /* setmark p2, line 113 */
    lab0:
        z->c = c1;
    }
    return 1;
...
static int r_step1_noun(struct SN_env * z) {
    int among_var;
     /* not, line 131 */
    {   int ret = r_R1(z);
        if (ret == 0) goto lab0; /* call R1, line 131 */
        if (ret < 0) return ret;
    }
    return 0;
lab0:
    ...
    among_var = find_among_b(z, a_0, 2); /* substring, line 132 */
    if (!(among_var)) return 0;
    z->bra = z->c; /* ], line 132 */
    switch(among_var) {
        case 0: return 0;
        case 1:
            {   int ret = slice_from_s(z, 1, s_0); /* <-, line 136 */
                if (ret < 0) return ret;
            }
            z->B[0] = 1; /* set PRE, line 136 */
            break;
    }
    return 1;
}
...
static int r_step2(struct SN_env * z) {
    int among_var;
    {   int m1 = z->l - z->c; (void)m1; /* and, line 144 */
        {   int m2 = z->l - z->c; (void)m2; /* not, line 144 */
            if (!(z->B[0])) goto lab0; /* Boolean test PRE, line 144 */
            return 0;
        lab0:
            z->c = z->l - m2;
        }
        z->c = z->l - m1;
         /* not, line 144 */
        {   int ret = r_R1(z);
            if (ret == 0) goto lab1; /* call R1, line 144 */
            if (ret < 0) return ret;
        }
        return 0;
    lab1:
    ...
    z->ket = z->c; /* [, line 145 */
    among_var = find_among_b(z, a_1, 108); /* substring, line 145 */
    if (!(among_var)) return 0;
    z->bra = z->c; /* ], line 145 */
    switch(among_var) {
        case 0: return 0;
        case 1:
            z->B[1] = 1; /* set FOUND, line 165 */
...
static int r_step3(struct SN_env * z) {
    int among_var;
    {   int m1 = z->l - z->c; (void)m1; /* and, line 173 */
        if (!(z->B[1])) return 0; /* Boolean test FOUND, line 173 */
        z->c = z->l - m1;
         /* not, line 173 */
        {   int ret = r_R1(z);
            if (ret == 0) goto lab0; /* call R1, line 173 */
            if (ret < 0) return ret;
        }
        return 0;
    lab0:
    ...
    among_var = find_among_b(z, a_2, 2); /* substring, line 174 */
    if (!(among_var)) return 0;
    z->bra = z->c; /* ], line 174 */
    switch(among_var) {
        case 0: return 0;
        case 1:
            {   int ret = slice_from_s(z, 1, s_1); /* <-, line 176 */
                if (ret < 0) return ret;
            }
            z->B[2] = 1; /* set CHANGE, line 176 */
            break;
        case 2:
            {   int ret = slice_from_s(z, 1, s_2); /* <-, line 177 */
                if (ret < 0) return ret;
            }
            z->B[2] = 1; /* set CHANGE, line 177 */
            break;
    }
    return 1;
}
...
static int r_step4(struct SN_env * z) {
    int among_var;
    {   int m1 = z->l - z->c; (void)m1; /* and, line 185 */
        {   int m2 = z->l - z->c; (void)m2; /* or, line 185 */
            if (!(z->B[1])) goto lab1; /* Boolean test FOUND, line 185 */
            goto lab0;
        lab1:
            z->c = z->l - m2;
            if (!(z->B[0])) return 0; /* Boolean test PRE, line 185 */
        }
    lab0:
        z->c = z->l - m1;
        {   int m3 = z->l - z->c; (void)m3; /* not, line 185 */
            if (!(z->B[2])) goto lab2; /* Boolean test CHANGE, line 185 */
            return 0;
        lab2:
            z->c = z->l - m3;
        }
        z->c = z->l - m1;
         /* not, line 185 */
        {   int ret = r_R1(z);
            if (ret == 0) goto lab3; /* call R1, line 185 */
            if (ret < 0) return ret;
        }
        return 0;
    lab3:
    ...
    {   int i; for (i = 3; i > 0; i--) /* loop, line 185 */
        {               z->ket = z->c; /* [, line 186 */
        }
    }
    among_var = find_among_b(z, a_3, 72); /* substring, line 186 */
    if (!(among_var)) return 0;
    z->bra = z->c; /* ], line 186 */
    switch(among_var) {
        case 0: return 0;
...
static int r_step5(struct SN_env * z) {
    int among_var;
    {   int m1 = z->l - z->c; (void)m1; /* and, line 206 */
        if (!(z->B[2])) return 0; /* Boolean test CHANGE, line 206 */
        z->c = z->l - m1;
         /* not, line 206 */
        {   int ret = r_R1(z);
            if (ret == 0) goto lab0; /* call R1, line 206 */
            if (ret < 0) return ret;
        }
        return 0;
    lab0:
    ...
    among_var = find_among_b(z, a_4, 2); /* substring, line 207 */
    if (!(among_var)) return 0;
    z->bra = z->c; /* ], line 207 */
    switch(among_var) {
        case 0: return 0;
...
extern int stem(struct SN_env * z) {
    z->B[0] = 0; /* unset PRE, line 220 */
    z->B[1] = 0; /* unset FOUND, line 221 */
    z->B[2] = 0; /* unset CHANGE, line 222 */
    {   int c1 = z->c; /* do, line 223 */
        {   int ret = r_mark_regions(z);
            if (ret == 0) goto lab0; /* call mark_regions, line 223 */
            if (ret < 0) return ret;
        }
    lab0:
        z->c = c1;
    ...
    {   int m2 = z->l - z->c; (void)m2; /* do, line 226 */
        {   int ret = r_step1_noun(z);
            if (ret == 0) goto lab1; /* call step1_noun, line 226 */
            if (ret < 0) return ret;
        }
    lab1:
        z->c = z->l - m2;
    ...
    {   int m3 = z->l - z->c; (void)m3; /* do, line 227 */
        {   int ret = r_step2(z);
            if (ret == 0) goto lab2; /* call step2, line 227 */
            if (ret < 0) return ret;
        }
    lab2:
        z->c = z->l - m3;
    }
    {   int m4 = z->l - z->c; (void)m4; /* do, line 228 */
        {   int ret = r_step3(z);
            if (ret == 0) goto lab3; /* call step3, line 228 */
            if (ret < 0) return ret;
        }
    lab3:
        z->c = z->l - m4;
    }
    {   int m5 = z->l - z->c; (void)m5; /* do, line 229 */
        {   int ret = r_step4(z);
            if (ret == 0) goto lab4; /* call step4, line 229 */
            if (ret < 0) return ret;
        }
    lab4:
        z->c = z->l - m5;
    }
    {   int m6 = z->l - z->c; (void)m6; /* do, line 230 */
        {   int ret = r_step5(z);
            if (ret == 0) goto lab5; /* call step5, line 230 */
            if (ret < 0) return ret;
        }
    lab5:
        z->c = z->l - m6;
    }
    {   int m7 = z->l - z->c; (void)m7; /* do, line 231 */
        {   int ret = r_step3(z);
            if (ret == 0) goto lab6; /* call step3, line 231 */
            if (ret < 0) return ret;
        }
    lab6:
        z->c = z->l - m7;
...
extern struct SN_env * create_env(void) { return SN_create_env(0, 2, 3); }
